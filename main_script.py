...
import os
import datetime
from scraper_functions import scrape_and_process_fastdic, scrape_and_process_faraazin_with_selenium, scrape_and_process_google_translate, download_images, scrape_and_process_google_define_with_selenium
...
#df['Downloaded_Images_HTML'] = df['Words'].apply(lambda word: download_images(word, n=5))
